    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <button
                ...
                className="fixed lg:hidden z-50 top-5 left-52 p-2  bg-blue-600 text-white rounded-lg shadow"
            >
            ...
            <div
                 className={`fixed inset-y-0 left-0 w-72 bg-white shadow-lg transform ${showSidebar ? "translate-x-0" : "-translate-x-full"
                    } lg:translate-x-0 transition-transform duration-200 ease-in-out z-40`}
            >
                <div className="flex items-center gap-2 p-6 border-b mb-4">
                    <PawPrint className="w-8 h-8 text-blue-600" />
                    <h1 className="  font-bold  text-3xl  text-gray-800">Benavet</h1>
                </div>
                <nav className="p-4">
            ...
            <div className="lg:ml-72 p-4 lg:p-8 h-screen bg-amber-100">
